      ...
      body: StreamBuilder<DatabaseEvent>(
        ...
        builder: (context, userSnapshot) {
          ...
          return ListView(
            ...
            padding:
                const EdgeInsets.only(left: 20, right: 20, top: 36, bottom: 15),
            children: [
              ...
              StreamBuilder<Map<String, DatabaseEvent>>(
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    var morningData = snapshot.data!['morning']?.snapshot.value;
                    var morningSchedule = morningData != null
                        ? Map<String, dynamic>.from(morningData as Map)
                        : null;

                    // Mengambil data jadwal sore
                    var eveningData = snapshot.data!['evening']?.snapshot.value;
              ...
              StreamBuilder<Map<String, dynamic>>(
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    return Center(
                      child:
                          Text("Error loading feeder info: ${snapshot.error}"),
                    );
                  } else if (!snapshot.hasData || snapshot.data!.isEmpty) {
                    return const Center(
