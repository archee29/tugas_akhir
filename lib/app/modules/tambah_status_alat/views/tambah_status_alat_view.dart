...
class TambahStatusAlatView extends GetView<TambahStatusAlatController> {
  const TambahStatusAlatView({super.key});
      ...
      body: ListView(
        ...
        children: [
          Center(
            child: Stack(
              children: [
                GetBuilder<TambahStatusAlatController>(
                  builder: (controller) {
              ...
              child: ElevatedButton(
                onPressed: () async {
                  if (controller.isLoading.isFalse) {
                    await controller.tambahStatusAlat();
                  }
                },
                style: ElevatedButton.styleFrom(
